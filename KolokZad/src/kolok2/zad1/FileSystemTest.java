...
class File implements Comparable<File>{
    ...
    public File(String name, int size, LocalDateTime dateOfCreation) {
        this.name = name;
        this.size = size;
    ...
    public String printWithMonthAndDay(){
        return String.format("%s-%s",dateOfCreation.getMonth(),dateOfCreation.getDayOfMonth());
    }

    @Override
    public int compareTo(File o) {
        int x = this.dateOfCreation.compareTo(o.dateOfCreation);
        if (x == 0){
...
class FileSystem{
    TreeMap<String, TreeSet<File>> filesByName;
