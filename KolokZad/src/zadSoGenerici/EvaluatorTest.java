...
//    public static <T extends Comparable> IEvaluator<T> build(String line){
//        switch (line){
//            case ">" :
...
//        IEvaluator<T> ev = zadSoGenerici.aplicantevaluator.EvaluatorBuilder.build(operator);
...
//                System.out.println(zadSoGenerici.aplicantevaluator.Evaluator.evaluateExpression(left,right,operator));
//
//            }
...
//                System.out.println(zadSoGenerici.aplicantevaluator.Evaluator.evaluateExpression(parts[1],parts[3],operator));
//            }
//            else { // Students
//                operator = parts[3];
...
//                System.out.println(zadSoGenerici.aplicantevaluator.Evaluator.evaluateExpression(s1,s2,operator));
//            }
//        }
//
//    }
